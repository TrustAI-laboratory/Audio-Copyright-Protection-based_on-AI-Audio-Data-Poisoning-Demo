...
if __name__ == "__main__":
    ...
    ori_audio_path = "original_audio.wav"
    poisoned_audio_path = "poisoned_audio.wav"

    # Load the original audio file
    audio, sample_rate = librosa.load(ori_audio_path, sr=None)
    ...
    save_poisoned_audio(poisoned_audio_path, poisoned_audio, sample_rate)